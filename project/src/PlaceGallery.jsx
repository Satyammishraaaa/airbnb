...
export default function PlaceGallery({ place }) {
    ...
    return (
        <div className="relative">
            ...
            <button onClick={() => setShowAllPhotos(true)} className="cursor-pointer flex gap-1 absolute bottom-2 right-2 py-2 px-4 bg-white rounded-2xl border border-gray-400 shadow-md shadow-gray-500">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="size-6">
